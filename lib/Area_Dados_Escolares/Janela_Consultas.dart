...
import '../Topicos.dart' show Custom_GridView_Topicos, SubTopicos_Consulta, Topicos_DrawerAluno;
...
/*  Janela dos topicos de consulta
*   sobre o curso do aluno. */
class Aluno_Consultas extends StatelessWidget {
  const Aluno_Consultas({super.key});
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Custom_GridView_Topicos(                               // GridView cusomizavel.
            lstTopicos: SubTopicos_Consulta,                            // Topicos configurados.
