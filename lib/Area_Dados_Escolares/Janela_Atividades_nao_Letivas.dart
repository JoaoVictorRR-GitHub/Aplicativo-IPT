...
/*  Janela sobre os topicos de
*   atividades nao letivas. */
class Aluno_AtividadesNaoLetivas extends StatelessWidget {
  const Aluno_AtividadesNaoLetivas({super.key});
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Custom_GridView_Topicos(                             // GridView customizavel.
            lstTopicos: SubTopicos_AtividadesNaoLetivas,              // Topicos configurados.
            substituirPagina: false,                                  // Inidica que o link dos itens no Grid mantem a pagina atual na rota.
          ),
        ),
